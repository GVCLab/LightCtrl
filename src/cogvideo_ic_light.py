...
class Relighter:
    def __init__(self, 
        ...
        if not is_code_run:
            ...
            for i in range(self.num_frames):
                input_bg = self.create_dynamic_background(BGSource.TOP_LEFT_TO_BOTTOM_RIGHT,R=light_radius, frame_index=i, total_frames=self.num_frames)
            ...
            for i in range(self.num_frames):
                input_bg = self.create_dynamic_background(BGSource.BOTTOM_LEFT_TO_TOP_RIGHT,R=light_radius, frame_index=i, total_frames=self.num_frames)
            ...
            frames_circular = []
            for i in range(self.num_frames):
                input_bg = self.create_dynamic_background(BGSource.CIRCULAR,R=light_radius, frame_index=i, total_frames=self.num_frames)
            ...
            frames_smi_circular = []
            for i in range(self.num_frames):
                input_bg = self.create_dynamic_background(BGSource.SMI_CIRCULAR,R=light_radius, frame_index=i, total_frames=self.num_frames)
            ...
            for i in range(self.num_frames):
                input_bg = self.create_dynamic_background(BGSource.TOP_TO_BOTTOM,R=light_radius, frame_index=i, total_frames=self.num_frames)
            ...
            for i in range(self.num_frames):
                input_bg = self.create_dynamic_background(BGSource.LEFT_TO_RIGHT,R=light_radius, frame_index=i, total_frames=self.num_frames)
            ...
            for i in range(self.num_frames):
                input_bg = self.create_dynamic_background(BGSource.RADIUS_CHANGE,R=light_radius, frame_index=i, total_frames=self.num_frames)
    ...
    def create_dynamic_background(self, bg_source,R, frame_index, total_frames=16):
        ...
        if bg_source == BGSource.TOP_LEFT_TO_BOTTOM_RIGHT:
            ...
            light_x = self.image_width // 4  
            light_y = int(t * (self.image_height - 1))
        elif bg_source == BGSource.LEFT_TO_RIGHT:

            light_x = int(t * (self.image_width - 1))
            light_y = self.image_height // 4  
