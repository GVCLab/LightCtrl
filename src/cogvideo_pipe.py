...
from diffusers.schedulers import CogVideoXDDIMScheduler, CogVideoXDPMScheduler,DDIMInverseScheduler
from diffusers.utils import logging, replace_example_docstring
from diffusers.utils.torch_utils import randn_tensor
from diffusers.video_processor import VideoProcessor
from diffusers.pipelines.cogvideo.pipeline_output import CogVideoXPipelineOutput

# from src.cogvideo_inversion_pipe import CogVideoXInversePipeline

from src.cogvideo_ddim import cog_ddim_step
from src.cogvideo_ic_light import Relighter
        ...
        def inject_light_map_noise(x_T_total, bg_source,R, device, total_frames):
            ...
            for i in range(total_frames):
                ...
                if bg_source == BGSource.TOP_LEFT_TO_BOTTOM_RIGHT:
                    ...
                    # 光源半径随时间变化
                    light_x = image_width // 4  # 光源固定在中心
                    light_y = image_height // 4

                    # 初始半径和变化范围
                    base_radius = 5  # 初始半径
                    delta_radius = 12.5  # 半径变化范围
                ...
                import cv2
                # 创建一个空白图像用于保存结果
                visualization = np.zeros((image_height, image_width * 2), dtype=np.uint8)
                ...
                # 将光照梯度和掩码分别放在左右两边
                visualization[:, :image_width] = gradient_uint8
                visualization[:, image_width:] = mask_uint8
                ...
                x_T_total = x_T_total.to(dtype=self.transformer.dtype)
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            ...
            for i, t in enumerate(timesteps):
                ...
                if lbd > 0.2:
                    ...
                    ## fusion
                    relight_target = relighter(consist_target,normal_target,lbd=lbd)
